...
var GradingFormatService = /** @class */ (function () {
    function GradingFormatService() {
        this.doc = dynamo_1.default;
    }
    /*
        This function adds a grading format to the database
    */
    GradingFormatService.prototype.addGradingFormat = function (gradingFormat) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.doc.put(params).promise().then(function () {
                                log_1.default.info('Successfully added a grading format to the database');
                                return true;
                            }).catch(function (error) {
                                log_1.default.error('Error: could not add a grading format to the database');
    ...
    */
    GradingFormatService.prototype.getGradingFormatByType = function (gradingType) {
        return __awaiter(this, void 0, void 0, function () {
            var params;
            return __generator(this, function (_a) {
                switch (_a.label) {
...
var gradingFormatService = new GradingFormatService();
exports.default = gradingFormatService;
/* setup ------------------------------------------------------------------------------------------ */
