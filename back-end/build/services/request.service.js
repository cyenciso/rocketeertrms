...
var RequestService = /** @class */ (function () {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.doc.put(params).promise().then(function () {
                                log_1.default.info('Successfully added request');
                                return true;
                            }).catch(function (error) {
                                log_1.default.error('Error: could not add request to the database');
    ...
    */
    ...
    /*
        ...
        */
    RequestService.prototype.getRequestsByEmail = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            var params;
            return __generator(this, function (_a) {
                switch (_a.label) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.doc.update(params).promise().then(function () {
                                log_1.default.info('Successfully updated request');
                                return true;
                            }).catch(function (error) {
                                log_1.default.error(error);
                                return false;
