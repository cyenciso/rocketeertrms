...
exports.login = exports.Employee = void 0;
...
function login(name, password) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, employee_service_1.default.getEmployeeByUsername(name).then(function (employee) {
                        if (employee && employee.password === password) {
                            return employee;
                        }
                        else {
                            log_1.default.debug('User was not found in database, returning null from employee login function!');
                            return null;
                        }
                    })];
